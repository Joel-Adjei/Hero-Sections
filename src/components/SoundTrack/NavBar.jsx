...
const NavBar = () => {
    ...
    return (
        <>
            <div
                className={`${displayMobileNav} md:hidden fixed top-0 right-0 w-full h-[100vh] bg-green-700 opacity-[40%]`}
            ...
            <div className={"z-70"} >
                <nav className={"flex items-center px-3 py-2 justify-between z-20"}>
                    ...
                    <ul className={`${displayMobileNav} flex-col w-50 h-[100vh] fixed top-0 left-0  items-start bg-white md:items-center gap-4 
