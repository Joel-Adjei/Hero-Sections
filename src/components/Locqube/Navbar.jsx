            ...
            <nav className={"z-40 px-2 py-1"}>
                <div className={"sticky top-0 flex w-full px-3 py-2 rounded-lg bg-gray-900 items-center justify-between"}>
                    <div className={"flex items-center gap-3 justify-center text-white font-[Nexa]"}>
                        ...
                        <ul className={`${displayMobileNav} fixed bg-black h-full w-90 top-0 left-0 flex-col md:relative md:size-fit md:bg-transparent md:flex  md:flex-row`}>
                            <button
